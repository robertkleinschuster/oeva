import {convertStopTimeToInt, parseServiceDate, parseStopTimeString, parseStopTimeInt} from "./DateTime";
...
describe("DateTime", () => {
    it('adds days for hours greater then 24', () => {
        ...
        const result1 = parseStopTimeString('24:00:00', date)
        expect(formatISO(result1)).toEqual('2020-01-02T00:00:00+01:00')
        const result2 = parseStopTimeString('27:30:10', date)
        expect(formatISO(result2)).toEqual('2020-01-02T03:30:10+01:00')
        const result3 = parseStopTimeString('48:00:00', date)
